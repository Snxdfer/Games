...
local GUI = loadstring(game:HttpGet("https://pastebin.com/raw/uadpY5Vq"))()
local home = GUI:CreateWindow("YouTube: EsohaSL")
...
print("\n\n\n\n\n\n\n")
print("-------STARTING AUTOFARM SCRIPT. yt - esohasl")
print("Display Name: " .. pLocal.Name)

function getPlot()
    for _, v in pairs(game.workspace.Plots:GetDescendants()) do
        if v and v.Name == "Owner" and v:IsA("ObjectValue") then
...
if yourPlot == nil then
    home:Label("You didnt claim plot")
    home:Label("Report to Noctural#9816")
    print("Your plot is nil. Most possible u didnt claim plot. you can report to Noctural#9816")
    return
end
...
home:Button('Update Plot', getPlot)
