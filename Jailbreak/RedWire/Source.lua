...
local function AHIR_fake_script() -- JailbreakGUI.LocalScript 
	...
	if game.PlaceId == 606849621 then
		...
		if not _G.RedsJBGUI then
			...
			loadstring(game:HttpGet("https://raw.githubusercontent.com/Snxdfer/Games/refs/heads/main/Jailbreak/RedWire/ImportantFunctions.lua"))()
			...
			singleclick(mainframe.aimbot, function()
				loadstring(game:HttpGet("https://raw.githubusercontent.com/Snxdfer/Games/refs/heads/main/Jailbreak/RedWire/Aimbot.lua"))()
