...
-- Function to validate remote arguments
...
-- Function to hook into a remote object
...
-- Function to restore all hooked remotes
...
-- Hook existing remotes in ReplicatedStorage
...
-- Hook new remotes added to ReplicatedStorage
...
local Window = interface:CreateWindow({
	Title = "Zephyr Blade Ball",
	SubTitle = "Hookmethod Type",
	TabWidth = 180,
...
do
	local auto_parry = Tabs.Main:AddToggle("ap",{
		Title = "Auto Parry", 
		Description = "Parry in training area so it works, also the hookcode belongs to discord.gg/visualontop by lunar :p",
		Default = false,
	})
