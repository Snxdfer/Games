...
local Window = Rayfield:CreateWindow({
   ...
   ConfigurationSaving = {
      Enabled = true,
      FolderName = "Kronus Blade Ball", -- Create a custom folder for your hub/game
      FileName = "KronusConfig"
   },
   ...
   KeySettings = {
      ...
      Subtitle = "Key System",
      Note = "Key In Discord: discord.gg/diddybluds",
      FileName = "KronusKey",
      SaveKey = true,
...
local RandomizedParryAccuracyToggle = MainTab:CreateToggle({
   ...
   CurrentValue = false,
   Flag = "RandomizedParryAccuracyToggle",
   Callback = function(Value)
